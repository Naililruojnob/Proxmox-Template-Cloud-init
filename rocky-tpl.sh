...
cores=2
disk_size="20G"
rocky_image_url="https://dl.rockylinux.org/pub/rocky/9.5/images/x86_64/Rocky-9-GenericCloud-LVM-9.5-20241118.0.x86_64.qcow2"
rocky_image_name="Rocky-9-GenericCloud-LVM.latest.x86_64.qcow2"
